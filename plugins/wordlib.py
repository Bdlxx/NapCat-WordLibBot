...
# 命令前缀配置（可自定义）
ADD_WORD_COMMAND = "羽笙跟我学"
DELETE_WORD_COMMAND = "羽笙忘掉"
QUERY_WORD_COMMAND = "羽笙回忆一下"
ENCODE_COMMAND = "转码"  # 转码命令
...
# ========== 签到/好感度/昵称/排行榜配置 ==========
SIGN_COMMANDS = ["羽笙签到", "签到"]
FAVOR_ADD_RANGE = (0, 3)
FAVOR_MINUS_RANGE = (0, 2)
NICKNAME_COMMAND = "羽笙以后叫我"
NICKNAME_NEED_FAVOR = 10
RANK_COMMAND = "签到排行"
RANK_TOP_N = 10

# ========== 赞我功能配置 ==========
PRAISE_COMMANDS = ["羽笙赞我"]
PRAISE_COUNT = 10
# =========================================
